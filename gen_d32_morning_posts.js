// Day 32 Morning push - 6 posts for all active characters
// 主线推进：风亚（山海同步节点）、提理安（火种室地板打开）
// 日常/配角：羽烽、狐兰兹、旻、沃弗尔

const fs = require('fs');

const posts = [
  // 1. 风亚 - 主线推进（山与海同步的关键一按）
  {
